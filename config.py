...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7721054524:AAFSnnXk2G0xil2j2y874GmArpGmn6SEA7Y") 
    ...
    ADMIN = [int(admin) if id_pattern.search(
        admin) else admin for admin in os.environ.get('ADMIN', '5665480584').split()]  # ⚠️ Required
